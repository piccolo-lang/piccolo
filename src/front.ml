...
let _ =
  ...
  Format.fprintf formatter "%a@\n" 
    CBackend.(print_main Settings.nb_thread entry_point 
		main_def#esize main_def#esize main_def#esize) c_code
    (* second esize must be replaced by number of channel
       third esize must be replaced by size of the biggest choice
     *)
